...
export function PriceChart({ ticker }: { ticker: string }) {
  ...
  useEffect(() => {
    ...
    const chart = createChart(el, {
      ...
      timeScale: { borderColor: "#272352", rightOffset: 4, fixLeftEdge: true },
      crosshair: {
        mode: 1,
        vertLine: { color: "#8B5CF6", width: 1, style: 2, labelBackgroundColor: "#5B21B6" },
        horzLine: { color: "#8B5CF6", width: 1, style: 2, labelBackgroundColor: "#5B21B6" },
      },
