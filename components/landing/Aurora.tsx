  ...
  return (
    <div className={`pointer-events-none absolute inset-0 overflow-hidden ${className}`} aria-hidden="true">
      <div
        ...
        style={{ top: "-6%", left: "8%", width: 360, height: 360, background: "#8B5CF6" }}
      />
      <div
      ...
      <div
        ...
        style={{ bottom: "-10%", left: "35%", width: 420, height: 420, background: "#5B21B6" }}
      />
      <div
        className="aurora-blob animate-float [animation-delay:2.2s]"
        style={{ bottom: "4%", right: "24%", width: 220, height: 220, background: "#22D3EE", opacity: 0.28 }}
      />
    </div>
  );
}
